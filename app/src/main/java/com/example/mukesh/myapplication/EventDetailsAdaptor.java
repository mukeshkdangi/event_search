...

{
    ...
    public EventDetailsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        EventDetailsViewHolder eventDetailsViewHolder = new EventDetailsViewHolder(view, context, eventDetailList);
    ...
    public static class EventDetailsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public EventDetailsViewHolder(@NonNull View itemView, Context context, List<EventDetails> eventDetails) {
            super(itemView);
            this.context = context;
